...
namespace SparkAuto.Data
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public async void Initialize()
        {
            ...
            {
                UserName = "edielsom@hotmail.com",
                Email = "edielsom@hotmail.com",
                Name = "Edielson Silverio",
                EmailConfirmed = true,
                PhoneNumber = "9.9999-9999"
            }, "Geo@101322").GetAwaiter().GetResult();


            _userManager.AddToRoleAsync(_db.Users.
                                        FirstOrDefaultAsync(u => u.Email == "edielsom@hotmail.com")
                                        .GetAwaiter().GetResult(), SD.AdminEndUser)
                                        .GetAwaiter()
                                        .GetResult();
